...
export const RegisterPage = () => {
  ...
  return (
    <>
      <head>
        <title>Registrarse | QuaraStore</title>
        <meta
          name="description"
          content="Regístrate en QuaraStore para crear una cuenta y acceder a nuestros servicios. Completa tus datos personales y elige una contraseña segura para comenzar a disfrutar de nuestras funcionalidades."
        />
      </head>
