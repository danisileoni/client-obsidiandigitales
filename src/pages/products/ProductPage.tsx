        ...
        <div>
          ...
          <div className="flex flex-col items-center bg-white p-4 md:p-8 rounded-t-md justify-start md:flex-row md:justify-center md:items-start">
            <Carousel
              ...
              className="shadow-md shadow-gray-300 rounded-md bg-gray-300 xs:h-[400px] md:h-[350px] xs:w-[400px] md:w-[300px]"
            >
              <CarouselContent>
                  ...
                  return (
                    <CarouselItem key={image}>
                      <picture>
                        <img
                          src={image}
                          className="object-cover rounded-md xs:h-[400px] md:h-[350px] xs:w-[400px] md:w-[300px]"
                          alt={product.title}
                        />
                      </picture>
                    </CarouselItem>
