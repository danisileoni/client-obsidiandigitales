export const VisaMasterCardIcon = () => {
  return (
    <svg
      ...
      width="2em"
      height="2em"
      className="bg-gray-200 p-[3px] rounded-sm h-5"
    >
      <title>Visa y Mastercard</title>
