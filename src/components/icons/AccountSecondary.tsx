...
export function AccountSecondary() {
  ...
  return (
    <div className="relative group">
      ...
      {showToolTip && (
        <div className="absolute bottom-full mb-2 left-32 md:-translate-x-[21.8rem]  max-md:-translate-x-[21.8rem] transform -translate-x-1/2 w-72 p-2 bg-black text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity ">
          <ul>
            CUENTA SECUNDARIA:
            <li className="pb-1">
